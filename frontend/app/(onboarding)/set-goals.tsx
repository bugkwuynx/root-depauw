...
export default function SetGoalsScreen() {
  ...
  const canContinue = prefsLoaded && (selected.size > 0 || customHabitOk) && !isSaving;
        ...
        >
          ...
          <View style={styles.hero}>
            ...
            <Text style={styles.subtitle}>
              Pick the areas that matter right now. You can refine them later—this is just a starting
              map.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            {!prefsLoaded ? (
              <View style={styles.prefsLoading}>
                ...
                <Text style={styles.prefsLoadingText}>Loading your saved goals…</Text>
              </View>
            ) : (
              <>
                    ...
                    <View style={styles.chipColumn}>
                      {group.goals.map((g) => {
                        ...
                        return (
                          ...
                          >
                            <View style={[styles.chipDot, isOn && styles.chipDotSelected]} />
                ...
                <View style={styles.customSection}>
                  <View style={styles.customLabelRow}>
                    ...
                    <Text style={styles.customHint}>Optional if you chose suggestions above</Text>
                  </View>
                  <TextInput
                    value={customHabit}
                  ...
                  {customHabit.length > 0 && !customHabitOk ? (
                    <Text style={styles.customError}>{`At least ${CUSTOM_HABIT_MIN_LEN} characters to count.`}</Text>
                  ) : null}
                </View>
              </>
            )}
