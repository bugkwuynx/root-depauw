...
export default function LoginScreen() {
  ...
  }, [email, isSubmittingEmail, isSubmittingGoogle, password.length]);

  const onLoginWithEmail = React.useCallback(async () => {
        ...
        >
          ...
          >
            ...
            <View style={styles.hero}>
              ...
              <Text style={styles.subtitle}>Log in to keep growing your habits.</Text>
            </View>
            ...
            <View style={styles.card}>
              ...
              <Field label="Password" hint="At least 8 characters" error={passwordError}>
                <TextInput
                  ...
                  autoCapitalize="none"
                  returnKeyType="done"
                  onSubmitEditing={onLoginWithEmail}
                  style={styles.input}
                />
              </Field>
              ...
              <Pressable
                ...
                disabled={!request || isSubmittingEmail || isSubmittingGoogle}                style={({ pressed }) => [
                  styles.googleButton,
...
const styles = StyleSheet.create({
  ...
  primaryButton: {
    ...
    alignItems: 'center',
    borderWidth: 1,
    borderColor: THEME.accenLight,
    shadowColor: THEME.groundDark,
    shadowOpacity: 0.14,
    shadowRadius: 14,
  ...
  dividerLine: {
    flex: 1,
    height: 1,
    backgroundColor: 'rgba(188, 176, 160, 0.55)',
  },
  dividerText: {
    fontSize: 12,
    color: THEME.groundDark,
